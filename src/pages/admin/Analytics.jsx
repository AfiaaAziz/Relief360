...
const CardTitle = ({ children }) => (
  <h3 className="text-xl font-black text-white" style={{ textShadow: '0 2px 8px rgba(0, 0, 0, 0.3)', lineHeight: '1.3', paddingBottom: '0.25rem' }}>{children}</h3>
);
const CardDescription = ({ children }) => (
  <p className="text-sm text-white/90 mt-2 font-semibold" style={{ textShadow: '0 1px 4px rgba(0, 0, 0, 0.2)' }}>{children}</p>
);
      ...
      <svg viewBox="0 0 800 240" className="w-full h-full">
        <path
          d={`M 50,200 ${data
            .map(
              (d, i) =>
                `${50 + (i * 700) / (data.length - 1 || 1)},${200 - d.incidents * scale}`
            )
            .join(" L ")} L 750,200`}
          fill="none"
          stroke="#3b82f6"
  ...
  return (
    <div className="w-full h-64 flex items-center justify-center">
      <svg viewBox="0 0 200 200" className="w-48 h-48">
        ...
        {criticalPct > 0 && (
          <path
            d={`M100,100 L100,20 A80,80 0 ${criticalPct > 180 ? 1 : 0},1 ${100 + 80 * Math.cos((criticalPct * Math.PI) / 180 - Math.PI / 2)},${100 + 80 * Math.sin((criticalPct * Math.PI) / 180 - Math.PI / 2)} Z`}
            fill="#dc2626"
          />
        )}
        {highPct > 0 && (
          <path
            d={`M100,100 L${100 + 80 * Math.cos((criticalPct * Math.PI) / 180 - Math.PI / 2)},${100 + 80 * Math.sin((criticalPct * Math.PI) / 180 - Math.PI / 2)} A80,80 0 ${highPct > 180 ? 1 : 0},1 ${100 + 80 * Math.cos(((criticalPct + highPct) * Math.PI) / 180 - Math.PI / 2)},${100 + 80 * Math.sin(((criticalPct + highPct) * Math.PI) / 180 - Math.PI / 2)} Z`}
            fill="#ef4444"
          />
        )}
        {mediumPct > 0 && (
          <path
            d={`M100,100 L${100 + 80 * Math.cos(((criticalPct + highPct) * Math.PI) / 180 - Math.PI / 2)},${100 + 80 * Math.sin(((criticalPct + highPct) * Math.PI) / 180 - Math.PI / 2)} A80,80 0 ${mediumPct > 180 ? 1 : 0},1 ${100 + 80 * Math.cos(((criticalPct + highPct + mediumPct) * Math.PI) / 180 - Math.PI / 2)},${100 + 80 * Math.sin(((criticalPct + highPct + mediumPct) * Math.PI) / 180 - Math.PI / 2)} Z`}
            fill="#f59e0b"
          />
        )}
        {(severityCounts.low / total) * 360 > 0 && (
          <path
            d={`M100,100 L${100 + 80 * Math.cos(((criticalPct + highPct + mediumPct) * Math.PI) / 180 - Math.PI / 2)},${100 + 80 * Math.sin(((criticalPct + highPct + mediumPct) * Math.PI) / 180 - Math.PI / 2)} A80,80 0 ${(severityCounts.low / total) * 360 > 180 ? 1 : 0},1 100,20 Z`}
            fill="#10b981"
          />
        )}
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const incidentsData = incidentsRes.ok
