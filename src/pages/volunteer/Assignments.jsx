                ...
                >
                  ...
                  <TableCellStyled>
                    <div className="flex gap-2">
                      <Dialog open={dialogOpen[incident.id]} onOpenChange={(open) => setDialogOpen({...dialogOpen, [incident.id]: open})}>
                        ...
                        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                          ...
                          <div className="space-y-4 py-4">
                            <div className="grid grid-cols-2 gap-4">
                              <div className="p-4 rounded-xl" style={{ background: 'linear-gradient(135deg, rgba(22, 83, 126, 0.1) 0%, rgba(22, 83, 126, 0.05) 100%)' }}>
                              ...
                              <div className="p-4 rounded-xl" style={{ background: 'linear-gradient(135deg, rgba(106, 168, 79, 0.1) 0%, rgba(106, 168, 79, 0.05) 100%)' }}>
                                <p className="text-sm font-bold mb-2" style={{ color: '#666' }}>
                                  Severity
                                </p>
                                <Badge
                              ...
                              <div className="col-span-2">
                                ...
                                <div className="flex items-center gap-2 p-3 rounded-xl" style={{ background: 'linear-gradient(135deg, rgba(22, 83, 126, 0.1) 0%, rgba(22, 83, 126, 0.05) 100%)' }}>
                                  <MapPin className="h-4 w-4" style={{ color: '#16537e' }} />
                              ...
                              <div className="col-span-2">
                                ...
                                <div className="flex items-center gap-2 p-3 rounded-xl" style={{ background: 'linear-gradient(135deg, rgba(106, 168, 79, 0.1) 0%, rgba(106, 168, 79, 0.05) 100%)' }}>
                                  <Calendar className="h-4 w-4" style={{ color: '#6aa84f' }} />
                              ...
                              <div className="col-span-2">
                                ...
                                <p className="text-sm p-4 rounded-xl font-semibold" style={{ background: 'linear-gradient(135deg, rgba(248, 250, 252, 0.9) 0%, rgba(226, 232, 240, 0.9) 100%)', color: '#333' }}>
