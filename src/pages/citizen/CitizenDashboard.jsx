      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card className="animate-slide-up" style={{ animationDelay: '0.1s' }}>
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            ...
            <FileText className="h-5 w-5 text-white" style={{ filter: 'drop-shadow(0 2px 4px rgba(0,0,0,0.3))' }} />
          </CardHeader>
          <CardContent>
            <div className="text-3xl font-black" style={{ color: '#16537e' }}>{stats.totalIncidents}</div>
            <p className="text-xs text-gray-500 mt-1 font-semibold">Reported incidents</p>
          </CardContent>
        </Card>
        <Card className="animate-slide-up" style={{ animationDelay: '0.2s' }}>
          ...
          <CardContent>
            <div className="text-3xl font-black" style={{ color: '#f48836' }}>{stats.pendingIncidents}</div>
            <p className="text-xs text-gray-500 mt-1 font-semibold">Awaiting response</p>
          </CardContent>
        </Card>
        ...
        <Card className="animate-slide-up" style={{ animationDelay: '0.4s' }}>
          ...
          <CardContent>
            <div className="text-3xl font-black" style={{ color: '#ff3535' }}>{stats.activeAlerts}</div>
            <p className="text-xs text-gray-500 mt-1 font-semibold">Current alerts</p>
          </CardContent>
        </Card>
      </div>
        ...
        <CardContent className="space-y-4">
          ...
          >
            <div className="flex items-start justify-between">
              <div>
                <p className="font-black text-lg" style={{ color: '#16537e' }}>Flood Warning - Lahore</p>
          ...
          >
            <div className="flex items-start justify-between">
              <div>
                <p className="font-black text-lg" style={{ color: '#16537e' }}>Heatwave Alert - Multan</p>
                <p className="text-sm font-semibold mt-1" style={{ color: '#666' }}>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          <Link to="/citizen-dashboard/report">
            <Card className="hover:shadow-lg transition-all duration-300 cursor-pointer transform hover:scale-105">
              <CardHeader>
                <AlertCircle className="h-8 w-8 text-white mb-2" style={{ filter: 'drop-shadow(0 2px 4px rgba(0,0,0,0.3))' }} />
          ...
          <Link to="/citizen-dashboard/hospitals">
            <Card className="hover:shadow-lg transition-all duration-300 cursor-pointer transform hover:scale-105">
              <CardHeader>
                <Hospital className="h-8 w-8 text-white mb-2" style={{ filter: 'drop-shadow(0 2px 4px rgba(0,0,0,0.3))' }} />
          ...
          <Link to="/citizen-dashboard/safety">
            <Card className="hover:shadow-lg transition-all duration-300 cursor-pointer transform hover:scale-105">
              <CardHeader>
                <Shield className="h-8 w-8 text-white mb-2" style={{ filter: 'drop-shadow(0 2px 4px rgba(0,0,0,0.3))' }} />
          ...
          <Link to="/citizen-dashboard/contacts">
            <Card className="hover:shadow-lg transition-all duration-300 cursor-pointer transform hover:scale-105">
              <CardHeader>
                <Phone className="h-8 w-8 text-white mb-2" style={{ filter: 'drop-shadow(0 2px 4px rgba(0,0,0,0.3))' }} />
